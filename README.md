...
- IRC/Matrix: [`#fedora-coreos` on Libera.Chat](ircs://irc.libera.chat:6697/#fedora-coreos) (For Matrix see [How to use Element as an IRC client](https://meta.wikimedia.org/wiki/Matrix.org#Using_Element_as_an_IRC_client))
